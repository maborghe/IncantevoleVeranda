...
export class ConsigliComponent {
  cardItems = [
    ...
    { imageSrc: 'assets/consigli/phi_beach.png', title: 'Divertimento', route: DIVERTIMENTO_ROUTE },
    //{ imageSrc: 'assets/consigli/dove-mangiare.jpg', title: 'Dove mangiare', route: '/baja-sardinia' },
    { imageSrc: 'assets/consigli/faro_lamaddalena.jpg', title: 'Attività', route: COSA_FARE_ROUTE },
